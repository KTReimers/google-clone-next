...
export default function ImageSearchResults({results}) {
    return (
        <div className="sm:pb-24 pb-40 mt-4">
            <p className="text-gray-600 text-sm mb-3 mt-3 w-full mx-auto px-3 sm:pl-[5%] md:pl-[14%] lg:pl-52">About {results.searchInformation?.formattedTotalResults} results ({results.searchInformation?.formattedSearchTime} seconds)</p>
